...
DB_NAME = os.environ.get("DB_NAME", "mongodb+srv://Prajwalraj:prajwalraj@cluster0.hhn6zsc.mongodb.net/?retryWrites=true&w=majority")     

DB_URL = os.environ.get("DB_URL", "Prajwalraj")
